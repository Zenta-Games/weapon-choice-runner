...
public class Screenshot : EditorWindow
{
	...
	[MenuItem("Zenta/Zenta Screenshot")]
	...
	void OnGUI()
	{
		...
		openImage = EditorGUILayout.Toggle("Open Taken Screenshot", openImage);
		multiple = EditorGUILayout.Toggle("IOS Screenshot", multiple);
	...
	private static ScreenshotResolution[] resolutions = new ScreenshotResolution[3]
	{
		new ScreenshotResolution(1242,2208),
		new ScreenshotResolution(1242,2688),
		new ScreenshotResolution(2048,2732)
	};
	...
	public void TakeHiResShot(bool multiple) {
		...
		if (multiple)
        {
			...
			{
				int resWidthN = resolutions[i].width;
				int resHeightN = resolutions[i].height;

				Screen.SetResolution(resWidthN, resHeight, false);
